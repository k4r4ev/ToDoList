  ...
  render() {
    ...
    if (this.props.completed === true) {
      ...
      changeTask = (
        <IconButton
          onClick={() =>
            this.props.changeTask(this.props.taskOrder, this.props.name)
          }
          aria-label="edit"
          size="small"
        >
      ...
      completeTask = (
        <IconButton
          onClick={() => this.props.completeTask(this.props.taskOrder)}
          aria-label="add"
          size="small"
        >
    ...
    return (
      <ListItem button>
        ...
        <span>
          {changeTask}
          <IconButton
            onClick={() => this.props.deleteTask(this.props.taskOrder)}
            aria-label="delete"
            size="small"
          >
            {" "}
